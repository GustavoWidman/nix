...
let
  ...
  commonEnvironment = {
    ...
    EMBEDDING__MODEL_CONFIG__TRANSPORT = "gemini";
    EMBEDDING__MODEL_CONFIG__MODEL = "gemini-embedding-2";
    EMBEDDING__MODEL_CONFIG__MAX_BATCH_SIZE = "10";
    EMBEDDING__MAX_CONCURRENT_EMBEDDINGS = "1";
    EMBEDDING__VECTOR_DIMENSIONS = "1536";
  };
